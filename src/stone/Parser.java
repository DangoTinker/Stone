...
public class Parser {
    protected static abstract class Element {
        protected abstract void parse(Lexer lexer, ArrayList<ASTree> res)
    ...
    protected static class Tree extends Element {
        ...
        protected void parse(Lexer lexer, ArrayList<ASTree> res)
            throws ParseException
        {
    ...
    protected static class Leaf extends Element {
        ...
        protected void find(ArrayList<ASTree> res, Token t) {
    ...
    protected static class Expr extends Element {
        ...
        public void parse(Lexer lexer, ArrayList<ASTree> res) throws ParseException {
            ...
            if (f == null)
                f = new Factory() {
                    protected ASTree make0(Object arg) throws Exception {
                    	ArrayList<ASTree> results = (ArrayList<ASTree>)arg;
                        if (results.size() == 1)
